 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    // the Solver function below.
      ...
      for (int t = 0; t < N ; t++){
          // at higher speeds, we tend to have higher Cross track errors - that needs to be penalized..
    ...
    for (int t = 0; t < N - 1; t++) {
        ...
        // we will punish the vehicle for steering at high speed around the bends.......
          fg[0] +=  5000 * CppAD::pow(vars[delta_start + t] * vars[v_start+t], 2);
          fg[0] +=  1000 * CppAD::pow(vars[epsi_start + t] * vars[v_start+t], 2);
      ...
      for (int t = 1; t < N; t++) {
          ...
          //AD<double> psides0 = CppAD::atan(coeffs[1]); // works only for 1 degree polynomial
